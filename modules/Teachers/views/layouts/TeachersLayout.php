    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                <!-- Dropdown Trigger -->
                <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'><img src="images/user/6.png" alt="" /><?=Yii::$app->user->identity->username?> <i class="fa fa-angle-down" aria-hidden="true"></i>
                </a>
            ...
            <div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['site'])?>" class="collapsible-header"><i class="fa fa-book" aria-hidden="true"></i> My classes</a>
                        </li>
                        <li><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/Teachers/default/students'])?>" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Create Student</a>
                        </li>
                        <li><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/Teachers/default/allstudents'])?>"><i class="fa fa-bookmark-o" aria-hidden="true"></i>All Students</a>
                        <li><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/Teachers/default/studentsearch'])?>"><i class="fa fa-bookmark-o" aria-hidden="true"></i>Search Student</a>
                        </li>
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-bars" aria-hidden="true"></i> Assingments</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="upload new assingment">New Assingment</a></li>
									<li><a href="admin-about-menu.html">Submited Assingments</a></li>
									<li><a href="admin-admission-menu.html">Active Assingments</a></li>
                                </ul>
                            </div>
                        </li>
						<li><a href="grades"><i class="fa fa-image" aria-hidden="true"></i> Grades</a>
                        </li>
                        <li><a href="calender" class="collapsible-header"><i class="fa fa-calendar" aria-hidden="true"></i> Planner</a>
