...
use app\modules\Admin\Administratorsearch;
...
/**
 * DefaultController implements the CRUD actions for Administrator model.
 */
class DefaultController extends Controller
{
    ...
    {
        if (($model = Administrator::findOne(['id' => $id])) !== null) {
            return $model;
        }
